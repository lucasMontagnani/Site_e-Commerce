  ...
  <div id="mall">
    <div class="minimenu"> 
      <ul align="right" id="ls">
        <?php 
          if (isset($e) && isset($s)) {
            echo "<li><a href='../adm/perfil_adm.php'>$e</a></li>
                  <div class='log'><b>|</b></div>
                  <div class='user'><li><a href='../adm/logout_adm.php'>LOG OUT</a></li></div>"; 
          }else{
    ...
    <div class="menu">
      <ul align="right">
        <li>
          <div id="logo">
            <a href="../php/homepage.php"><!-- <img src="../imagens/signup-login/menu_logo2.png" width="150" height="121"  /> --></a>
          </div>
        </li>
        <li>
          <div id="search">
        ...
        <li><a href='perfil_adm.php'>ADM</a></li>
  ...
  <script type="text/javascript">
    ...
    // var h = window.innerHeight;
     ...
     function scrollFunction()  {
         ...
         if ((document.body.scrollTop > 100 && w > 879) || (document.documentElement.scrollTop > 100 && w > 879)) {
