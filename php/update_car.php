...
echo "Nova quantidade: ".$pro_qtd;
echo "O produto: ".$cd_produto;
echo "Novo tamanho: ".$pro_tamanho;
...
$qp = mysql_query("UPDATE tb_carrinho SET qt_produto= '".$pro_qtd."',cd_tamanho= '".$pro_tamanho."' WHERE cd_usuario = '".$rows_produtos['cd_usuario']."' and cd_carrinho = '".$carrinho."'");
if (!$qp) {
	mysql_error();
}else{
	header("Location: alert_page_edit.php");
}
